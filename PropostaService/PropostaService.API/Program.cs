...
using Proposta.Application.Configurations;
...
{
    x.SwaggerDoc("v1", new OpenApiInfo { Title = "PropostaService.Api", Version = "v1" });
...
app.UseSwagger();
app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "PropostaService.Api"));
